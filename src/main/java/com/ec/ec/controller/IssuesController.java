...
public class IssuesController {
    ...
    //更新商品
    @GetMapping("updata")
    public DataVo updata(Integer id,  String issuesName, String issuesUrl, Integer issuesNum, String issuesDetails, Double issuesPrice) {
        Issues issues=new Issues( id, issuesName,  issuesUrl,  issuesNum,  issuesDetails,  issuesPrice);
        DataVo dataVo=new DataVo();
        try {
